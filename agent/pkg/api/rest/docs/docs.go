...
const docTemplate = `{
    ...
    "definitions": {
        "github_com_cloud-barista_cm-honeybee_agent_gpu_drm.DRM": {
            "type": "object",
            "properties": {
                "driver_date": {
                    "type": "string"
        ...
        "github_com_cloud-barista_cm-honeybee_agent_gpu_nvidia.DeviceAttribute": {
            "type": "object",
            "properties": {
                "cuda_version": {
                    "type": "string"
        ...
        "github_com_cloud-barista_cm-honeybee_agent_gpu_nvidia.NVIDIA": {
            "type": "object",
            "properties": {
                "device_attribute": {
                    "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_gpu_nvidia.DeviceAttribute"
                },
                "performance": {
                    "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_gpu_nvidia.Performance"
                }
            }
        },
        "github_com_cloud-barista_cm-honeybee_agent_gpu_nvidia.Performance": {
            "type": "object",
            "properties": {
                "bar1_memory_total": {
                    "description": "mb",
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_infra.GPU": {
            ...
            "properties": {
                "drm": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_gpu_drm.DRM"
                    }
                },
                "nvidia": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_gpu_nvidia.NVIDIA"
                    }
                }
            }
        },
