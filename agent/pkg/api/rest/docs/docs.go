...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_infra.MinIO": {
            ...
            "properties": {
                ...
                "buckets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_infra.MinioBucket"
                    }
                },
                "config_path": {
                    "type": "string"
                ...
                "server_info": {
                    "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_infra.MinIOServerInfo"
                },
                "version": {
                    "type": "string"
                },
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_infra.MinIOServerInfo": {
            "type": "object",
            "properties": {
                "disks": {
                    "type": "integer"
                ...
                "storage_info": {
                    "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_infra.MinIOStorageInfo"
                }
            }
        },
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_infra.MinIOStorageInfo": {
            "type": "object",
            "properties": {
                "free_gb": {
                    "type": "number"
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_kubernetes.Node": {
            ...
            "properties": {
                ...
                "node_info": {},
                "node_spec": {
                    "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_kubernetes.NodeSpec"
                },
                "type": {
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_kubernetes.NodeGPU": {
            "type": "object",
            "properties": {
                "allocatable": {
                    "type": "integer"
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_kubernetes.NodeSpec": {
            "type": "object",
            "properties": {
                "cpu": {
                    "description": "cores",
                ...
                "gpu": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_kubernetes.NodeGPU"
                    }
                },
                "memory": {
                    "description": "MiB",
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_software.Binary": {
            "type": "object",
            "properties": {
                "cmdline": {
                    "type": "string"
                ...
                "config_files": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_software.ConfigFile"
                    }
                },
                "connection_status": {
                    "type": "string"
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_software.ConfigFile": {
            "type": "object",
            "properties": {
                "path": {
                    "type": "string"
        ...
        "github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_software.Software": {
            ...
            "properties": {
                ...
                "legacy": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_agent_pkg_api_rest_model_onprem_software.Binary"
                    }
                },
                "podman": {
                    "type": "array",
