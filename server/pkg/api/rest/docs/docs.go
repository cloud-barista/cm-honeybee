...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/source_group/{sgId}/agent": {
            "delete": {
                ...
                "operationId": "uninstall-agent-source-group",
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID of the SourceGroup",
                ...
                "responses": {
                    "200": {
                        "description": "Per-host uninstall results.",
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.SimpleMsg"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to uninstall the agents.",
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_common.ErrorResponse"
                        }
                    }
        ...
        "/source_group/{sgId}/connection_info/{connId}/agent": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Agent uninstalled, or kept because it is still shared.",
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.SimpleMsg"
                        }
                    },
                    ...
                    "500": {
                        "description": "Failed to uninstall the agent.",
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_common.ErrorResponse"
                        }
                    }
        ...
        "/source_group/{sgId}/region": {
            "get": {
                ...
                "operationId": "list-source-group-regions",
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID of the SourceGroup (csp type)",
                        "name": "sgId",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Regions and zones",
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.ListRegionRes"
                        }
                    },
                    "400": {
                        "description": "Not a csp-type source group / missing sgId",
                        "schema": {
                            "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_common.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.CSPCredentialField": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.CSPInfo": {
            ...
            "properties": {
                ...
                "credentials": {
                    "description": "Credentials lists each required credential key with an example value and a\nshort description, so a client can render a self-documenting input form.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.CSPCredentialField"
                    }
                },
                "default_region": {
                    "type": "string"
        ...
        "github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.CSPRegion": {
            "type": "object",
            "properties": {
                "display_name": {
                    "type": "string"
        ...
        "github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.ConnectionInfo": {
            ...
            "properties": {
                ...
                "kubeconfig": {
                    "description": "Kubeconfig — on-prem k8s credential (Type onprem + ResourceType k8s).",
                    "type": "string"
                },
                "name": {
                    "type": "string"
        ...
        "github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.CreateConnectionInfoReq": {
            ...
            "properties": {
                ...
                "kubeconfig": {
                    "description": "Kubeconfig — required when on-prem + ResourceType \"k8s\".",
                    "type": "string"
                },
                "name": {
                    "type": "string"
                ...
                "zone": {
                    "description": "Zone (optional) overrides the CSP zone for this connection. Empty → default.",
                    "type": "string"
                }
            }
        },
        ...
        "github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.ListRegionRes": {
            "type": "object",
            "properties": {
                "provider": {
                    "type": "string"
                ...
                "regions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_cloud-barista_cm-honeybee_server_pkg_api_rest_model.CSPRegion"
                    }
                }
            }
        },
        ...
        "infra.AMD": {
            ...
            "properties": {
                "device_attribute": {
                    "$ref": "#/definitions/infra.AMDDeviceAttribute"
                },
                "performance": {
                    "$ref": "#/definitions/infra.AMDPerformance"
                }
            }
        },
        "infra.AMDDeviceAttribute": {
            "type": "object",
            "properties": {
                "card": {
                    "type": "string"
        ...
        "infra.CSPInfo": {
            ...
            "properties": {
                ...
                "network": {
                    "$ref": "#/definitions/infra.CSPNetwork"
                },
                "platform": {
        ...
        "infra.CSPNetwork": {
            ...
            "properties": {
                "security_groups": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/infra.CSPSecurityGroup"
                    }
                },
                "subnet": {
                    "type": "string"
                ...
                "vpc": {
                    "$ref": "#/definitions/infra.CSPVPC"
                }
            }
        },
        "infra.CSPSecurityGroup": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
                ...
                "rules": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/infra.CSPSecurityRule"
                    }
                }
            }
        },
        "infra.CSPSecurityRule": {
            "type": "object",
            "properties": {
                "cidr": {
                    "type": "string"
        ...
        "infra.CSPVPC": {
            ...
            "properties": {
                ...
                "subnets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/infra.CSPSubnet"
                    }
                }
            }
        },
        ...
        "infra.NVIDIA": {
            ...
            "properties": {
                ...
                "ecc": {
                    "$ref": "#/definitions/infra.NVIDIAECC"
                },
                "mig_devices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/infra.NVIDIAMIGDevice"
                    }
                },
                "performance": {
                ...
                "processes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/infra.NVIDIAProcess"
                    }
                }
            }
        },
        ...
        "infra.NVIDIAECC": {
            ...
            "properties": {
                "aggregate": {
                    "$ref": "#/definitions/infra.NVIDIAECCErrors"
                },
                "mode": {
                    "type": "string"
                },
        ...
        "software.Software": {
            ...
            "properties": {
                ...
                "flatpak": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/software.Flatpak"
                    }
                },
                "legacy": {
                    "type": "array",
