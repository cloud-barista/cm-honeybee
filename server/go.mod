...
require (
	github.com/cloud-barista/cm-grasshopper v0.0.0-20250803111500-5cb36c6a2345
	github.com/cloud-barista/cm-honeybee/agent v0.0.0-20250803103810-0b3c4f1ff6f2
