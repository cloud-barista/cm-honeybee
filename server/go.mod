...
require (
	github.com/cloud-barista/cm-grasshopper v0.0.0-20250801092632-8f5f5962ec33
	github.com/cloud-barista/cm-honeybee/agent v0.0.0-20250802101655-d51f59aedc9b
